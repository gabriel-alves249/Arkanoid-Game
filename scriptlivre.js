...
// ========== VARIÁVEIS DO MODO LIVRE (SEM FASES) ==========
...
function criaBlocosLivre() {
    ...
    // ✅ Adiciona 5 blocos brancos com 2 hits
...
function collisionDetection() {
    ...
    if(blocosRestantes === 0 && !gameOver) {
        recarregaBlocosLivre();
    }
}
...
function updateBlocksDisplay() {
    ...
    document.getElementById('blocks-display').textContent = blocosDestruidos;
}
...
function drawGameOver() {
    ...
    ctx.font = "18px Arial";
    ctx.fillText('Score Final: ' + score, 170, 150);
    
    if(score > highscore) {
        ctx.fillText('🏆 Novo Recorde! 🏆', 145, 180);
    } else {
        ctx.fillText('Recorde: ' + highscore, 175, 180);
    }
